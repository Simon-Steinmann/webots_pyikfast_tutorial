...
static PyMethodDef pyikfast_irb4600_40Methods[] = {
    {"inverse", inverse, METH_VARARGS, "Calculate inverse kinematics"},
    {"forward", forward, METH_VARARGS, "Calculate forwards kinematics"},
    {NULL, NULL, 0, NULL}};

static struct PyModuleDef pyikfast_irb4600_40module = {
    PyModuleDef_HEAD_INIT,
    "pyikfast_irb4600_40",
    "ikfast wrapper",
    -1,
    pyikfast_irb4600_40Methods};

PyMODINIT_FUNC PyInit_pyikfast_irb4600_40(void)
{
  PyObject *module = PyModule_Create(&pyikfast_irb4600_40module);
  return module;
}
